...
const GitHubImportButton: React.FC<GitHubImportButtonProps> = ({
  onClick,
  isLoading,
  disabled,
}) => {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Automatically fill project details from your GitHub repositories
          </p>
        </div>
        <button
          onClick={onClick}
...
export default GitHubImportButton;
