    ...
    <div>
      ...
      <div className="space-y-6">
        ...
        <div className="p-4 border border-gray-300 rounded-md">
          ...
          <div className="mb-2">
            ...
            <div>
              {techStack.languages.length > 0 ? techStack.languages.join(', ') : 'None selected'}
            </div>
          </div>
          ...
          <div className="mb-2">
            ...
            <div>
              {techStack.frameworks.length > 0 ? techStack.frameworks.join(', ') : 'None selected'}
            </div>
          </div>

          <div>
            <div className="font-medium">Tools & Platforms:</div>
            <div>{techStack.tools.length > 0 ? techStack.tools.join(', ') : 'None selected'}</div>
          </div>
        </div>
      ...
      {!isAuthenticated ? (
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-sm text-blue-800 mb-3">Please sign in to submit your report.</p>
          <div className="flex gap-3">
            ...
            <Button onClick={signInWithGithub} className="bg-gray-800 text-white hover:bg-gray-900">
      ...
      >
        <div className="flex flex-col gap-4 py-2">
          <p className="text-sm text-gray-600">
            Please sign in with one of the following providers to submit your portfolio:
          </p>
          <button
            onClick={() => {
              signInWithGoogle();
